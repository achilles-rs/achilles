...
void lakko_procmap_iterate(lakko_procmap_cb cb)
{
	struct lakko_procmap_entry e;
	FILE *map;
...
static void __lakko_procmap_dump_helper(const struct lakko_procmap_entry *e)
{
...
void lakko_procmap_dump()
{
	printf("--- Process Map Dump ---\n");
	lakko_procmap_iterate(&__lakko_procmap_dump_helper);
}
